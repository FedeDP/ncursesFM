...
* Bookmarks initial support: it will load bookmarks from $HOME/.config/user-dirs.dirs and $HOME/.config/ncursesFM-bookmarks.
You can add a bookmark from withing ncursesFM, but you cannot remove a bookmark (for now).
